...
def get_system_info():
    ...
    info['reqchat_base_dir'] = os.environ.get('REQCHAT_BASE_DIR', 'out')
...
def generate_header():
    ...
    header = f"""# reqchat training report
    ...
    def generate(self):
        ...
        with open(report_file, "w", encoding="utf-8") as out_file:
            ...
            if os.path.exists(header_file):
                ...
                print(f"Warning: {header_file} does not exist. Did you forget to run `reqchat reset`?")
...
# -----------------------------------------------------------------------------
# reqchat-specific convenience functions
...
def get_report():
    ...
    from reqchat.common import get_base_dir, get_dist_info
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Generate or reset reqchat training reports.")

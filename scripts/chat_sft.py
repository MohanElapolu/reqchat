...
from reqchat.common import compute_init, compute_cleanup, get_base_dir, print0, DummyWandb, autodetect_device_type
...
wandb_run = DummyWandb() if use_dummy_wandb else wandb.init(project="reqchat-sft", name=run, config=user_config, save_code=True)
